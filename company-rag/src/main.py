...
async def query(request: QueryRequest):
    ...
    try:
        ...
        initial_state = { #ye h wo state jo state.py k format me h 
            "query": request.query,
            "original_query": request.query, # abhi dondo same h query but baad me bs original query deknge aur query wo preprocess me change hoga 
            "session_id": "",
            "intent": "",
            "entities": {},
            "agent_plans": [],
